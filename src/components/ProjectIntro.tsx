...
const ProjectIntro = () => {
  return (
    <>
      <div className="flex flex-col p-5 md:p-16 max-w-5xl w-full">
        ...
        <div className="flex flex-col">
          <ProjectCard
            title="TeeTime"
            description={[
              "A mobile only application that allows users to register for golf tournaments based on the users eligibilty. Tournaments are created by 'Host' user which during the creation process can set the eligibilty requirements for the tournament. When the user is registered for a tournament a QR code can be generated for the user to scan at the tournament to check in.",
            ]}
